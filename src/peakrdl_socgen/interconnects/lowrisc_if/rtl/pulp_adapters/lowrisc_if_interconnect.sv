...
/**
 * Simplistic Ibex lowrisc_if_interconnect implementation
 *
 * This module is designed for demo and simulation purposes, do not use it in
 * a real-world system.
 *
 * This implementation doesn't handle the full lowrisc_if_interconnect protocol, but makes the
 ...
 */
module lowrisc_if_interconnect #(
